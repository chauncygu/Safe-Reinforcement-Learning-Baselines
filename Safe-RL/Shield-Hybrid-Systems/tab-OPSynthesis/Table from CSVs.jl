...
# ╔═╡ 4b0e5a9b-7b47-4e26-b0c5-1d756fd1fb45
md"""
# OPSynthesis -- Table from CSVs
"""
...
# ╔═╡ 04180b0d-9630-485f-b8c3-5f818b6122a3
	...
	function get_algorithm(filename::AbstractString)
		...
		if m != nothing
			...
			if m != nothing
				...
				@warn "Unexpected filename: $filename\nCould not determine algorithm type.\nUsing placeholder: $best_effort"
				return best_effort
			end
		end
	end
...
begin
	...
	function n_from_grid_points(grid_points::AbstractString)
		n_from_grid_points(parse(Int, grid_points))
	end
end
...
# ╔═╡ 3cc02a78-ca6f-4ccc-aa90-b14842e34a1a
