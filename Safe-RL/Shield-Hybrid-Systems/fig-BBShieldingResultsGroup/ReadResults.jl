...
begin
	avg_cost_description = "Average \$hit\$ actions per 120s"
...
average_cost = call(() -> begin
	...
	make_label(experiment, d) = "d=$d" #"$(proper_experiment_name[experiment]) d=$d"
...
function fix_bad_sorting(runs)
	runs_labels = Dict(
		...
		150 => " 150", 300 => " 300", 600 => " 600",  1200 => "1200", # I try this
...
manifest_format = "2.0"
project_hash = "a99f67b2b87d5d15c50c80792715ece9bbe1bf6e"
