...
from planners import LinearProgrammingPlanner
...
def _solve(env, cost_bound, horizon=20):
    ...
    # assert abs(expected_value_mc - expected_value) < 0.2, "{:0.3f} != {:0.3f}".format(expected_value_mc, expected_value)
    # assert abs(expected_cost_mc - expected_cost) < 0.2, "{:0.3f} != {:0.3f}".format(expected_cost_mc, expected_cost)
